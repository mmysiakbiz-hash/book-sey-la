...
(function () {
  ...
  // ---------- ACCOUNT + LOGIN/OTP ----------
  function Account({ user, setUser, favs, nav, notif, setNotif, visitCount }) {
  ...
  function App() {
    ...
    else base = <Account user={user} setUser={setUser} favs={favs} nav={nav} notif={notif} setNotif={setNotif} visitCount={myVisits.length} />;
